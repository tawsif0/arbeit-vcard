                    ...
                    <form action="update.php" method="post" class="form" data-form>
                        <div class="input-wrapper">
                            ...
                            <input type="email" name="email" id="email" class="form-input"
                                ...
                                data-form-input autocomplete="off" />
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="phno" id="phno" class="form-input"
                                placeholder="Input new personal number" value="<?php echo $phno; ?>" required
                                data-form-input autocomplete="off" />
                            <input type="text" name="ophno" id="ophno" class="form-input"
                                placeholder="Input new office number" value="<?php echo $ophno; ?>" required
                                data-form-input autocomplete="off" />
                        </div>
